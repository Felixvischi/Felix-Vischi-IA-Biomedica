...
- **Qué hace:** Configura tu clave de API, inicializa el modelo `gemini-2.5-flash`, y ejecuta un prompt sencillo para verificar que la autenticación funciona y el modelo responde correctamente.
